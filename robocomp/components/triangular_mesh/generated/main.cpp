...
/** \mainpage RoboComp::triangular_mesh
 *
 * \section intro_sec Introduction
 *
 * The triangular_mesh component...
 *
 ...
 *
 * Just: "${PATH_TO_BINARY}/triangular_mesh --Ice.Config=${PATH_TO_CONFIG_FILE}"
 *
...
class triangular_mesh : public Ice::Application
{
public:
	triangular_mesh (QString configFile, QString prfx, bool startup_check) { 
...
Ice::InitializationData triangular_mesh::getInitializationDataIce(){
...
void triangular_mesh::initialize()
{
...
int triangular_mesh::run(int argc, char* argv[])
{
#ifdef USE_QTGUI
...
int main(int argc, char* argv[])
{
	...
	triangular_mesh app(configFile, prefix, startup_check_flag);
